...
function click1() {
    ...
    img.innerHTML="<img src='die1.png'>"
...
function click2() {
    ...
    var new_marker_position = new google.maps.LatLng(lat[markernumber], lng[markernumber]);
    marker.setPosition(new_marker_position);
    img.innerHTML="<img src='die2.png'>"
...
function click3() {
    ...
    text.innerHTML+="<p>和平島原名社寮島，位於基隆東北一禹，是基隆港的門戶，同時也是北台灣最早有西方人足跡的地方，亦是基隆最早有漢人入墾的所在地之一。此地早期原為凱達格蘭族的聚落，之後被列為軍事管制區，目前在沿海部份地區已開放設為和平島公園。和平島公園的遊憩重點，就是園區內重要的海蝕地形景觀，位在海岸線旁的奇岩巨石，因長期受迎風面海蝕及風蝕影響，造就了特殊的地形景觀，如海蝕崖、海蝕平台、海蝕溝、海蝕崖、風化窗、獅頭岩、熊頭岩等，最著名的則是「豆腐岩」和「萬人堆」（蕈狀石）地形景觀，各種不同的海蝕地形，是小朋友們戶外教學最喜歡來的地方，不僅可以真實看到課本上的圖片，也能實際的感受到自然的力量。</p>"
}
...
function click4() {
    ...
    text.innerHTML+="<p>基隆廟口的小吃最早可溯源至日據時代，而今日『廟口』已成為眾所周知的觀光地點，基隆廟口因位於俗稱『聖王廟』的『奠濟宮』前而得名；奠濟宮建於西元1873年，迄今已有100多年的歷史，是名副其實的百年古剎；奠濟宮供奉的是開漳聖王，是唐朝的陳元光將軍，開漳聖王是河南人，在西元686年奉命平定閩粵有功，因此死後封為開漳聖王；當時由基隆地方士紳白番，有濟堂連新永、自楊傳等購買外木山十多頃田地為廟產，以木料建廟其上，但是後來由板橋望族林本源等捐獻現在仁愛區王田里的土地再由地方士紳張金發及賴武等人捐款，並獲得地方熱烈響應，入廟後可見排列整齊的紅色大石柱，上面刻有敬神對聯，正殿主神前的花鳥石柱則是日治時期建的，因為日人崇尚花鳥之故，龍柱則是第二次世界大戰所造，展現了中國寺廟的風格特色。</p>"
}

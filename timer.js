...
function click1() {
    ...
    img.innerHTML="<img src='die1.jpg'>"
...
function click2() {
    ...
    var new_marker_position = new google.maps.LatLng(lat[markernumber], lng[markernumber]);
    marker.setPosition(new_marker_position);
    img.innerHTML="<img src='die2.jpg'>"
...
function click3() {
    ...
    var new_marker_position = new google.maps.LatLng(lat[markernumber], lng[markernumber]);
    marker.setPosition(new_marker_position);
    img.innerHTML="<img src='die3.jpg'>"
...
function click4() {
    ...
    var new_marker_position = new google.maps.LatLng(lat[markernumber], lng[markernumber]);
    marker.setPosition(new_marker_position);
    img.innerHTML="<img src='die4.jpg'>"
...
function click5() {
    ...
    var new_marker_position = new google.maps.LatLng(lat[markernumber], lng[markernumber]);
    marker.setPosition(new_marker_position);
    img.innerHTML="<img src='die5.jpg'>"
...
function click6() {
    ...
    var new_marker_position = new google.maps.LatLng(lat[markernumber], lng[markernumber]);
    marker.setPosition(new_marker_position);
    img.innerHTML="<img src='die6.jpg'>"
...
function click7() {
    ...
    var new_marker_position = new google.maps.LatLng(lat[markernumber], lng[markernumber]);
    marker.setPosition(new_marker_position);
    img.innerHTML="<img src='die7.jpg'>"
...
function click8() {
    ...
    var new_marker_position = new google.maps.LatLng(lat[markernumber], lng[markernumber]);
    marker.setPosition(new_marker_position);
    img.innerHTML="<img src='die8.jpg'>"
...
function click9() {
    ...
    var new_marker_position = new google.maps.LatLng(lat[markernumber], lng[markernumber]);
    marker.setPosition(new_marker_position);
    img.innerHTML="<img src='die9.jpg'>"
...
function click10() {
    ...
    var new_marker_position = new google.maps.LatLng(lat[markernumber], lng[markernumber]);
    marker.setPosition(new_marker_position);
    img.innerHTML="<img src='die10.jpg'>"
